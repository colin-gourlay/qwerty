        ...
        <div className={`flex items-center justify-between gap-8 transition-all duration-300 ${isScrolled ? 'py-2' : 'py-4'}`}>
          <Link to="/" className="flex items-center group flex-shrink-0">
            <img 
              ...
              className={`w-auto object-contain transition-all duration-500 ease-in-out group-hover:scale-105 group-hover:brightness-110 drop-shadow-md ${isScrolled ? 'h-12 opacity-90' : 'h-20 opacity-100'}`}
            />
          </Link>
